...
> **Note**: this branch is related only to Armor &ge; 1.2 &lt; 1.3 versions. That is, any modifications that would take Armor to
&ge;1.3 or &ge;2.0, for example, should not be made to this repository, but to the [default branch](https://github.com/14mPr0gr4mm3r/armor-lib/branches) (in the right development period).
